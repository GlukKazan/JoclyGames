...
chess-attacked     = true      Оптимизированный для Шахмат алгоритм определения attacked?
ko                 = true      Простое Ко (проверка совпадения с предыдущей позицией)
ko                 = position  Позиционное Супер Ко (совпадение позиции с любой из предыдущих)
ko                 = situation Ситуационное Супер Ко (совпадение позиции с учётом очерёдности хода)
ko                 = 3         Запрещать третье по счёту повторение ситуации
...
--------------------------------------------------
Изменение состояния модели применением к ней частичного хода. Возвращает
true если выполнено хотя бы одно действие.
